      ...
      <>
        <AppBar position="static">
          <Toolbar variant={isMobile ? "regular" : "dense"}>
            ...
            <Button color="inherit" onClick={endSession}>Logout</Button>
          </Toolbar>
        </AppBar>
        <Outlet />
        {isMobile ? (
          <AppBar position="fixed" color="primary" style={{ top: 'auto', bottom: 0 }}>
            <Toolbar sx={{ justifyContent: 'center', padding: 0 }}>
              ...
              <IconButton onClick={handleMenuClose} component={Link} to="/app/home" edge="start" color="inherit" aria-label="home" sx={{ fontSize: '2.5rem', width: '33.3%' }}>
                <HomeIcon />
              </IconButton>
